-- H2 2.1.214;
;             
CREATE USER IF NOT EXISTS "SA" SALT '19defd61a72055c5' HASH 'bcd4cbd34f41defac1d28e0d0c090216a7ae388a0ee2a0d6591d00a0e13669ca' ADMIN;         
...
-- 7 +/- SELECT COUNT(*) FROM PUBLIC.PERFIL_DO_USARIO;        
...
(130, 23, 'Max 10', 'https://i.pinimg.com/originals/12/1d/75/121d7557a37958c1c0121fdfa5272a3e.gif', 'user');    
...
-- 20 +/- SELECT COUNT(*) FROM PUBLIC.JOGOS;  
...
(25, 23, 'Bento', 'bento', 'Max', 'https://i.pinimg.com/originals/72/7c/0d/727c0ddf111b9db085d7dc7909ae3eae.gif');        
...
-- 30 +/- SELECT COUNT(*) FROM PUBLIC.COMENTARIODEJOGO;       
...
-- 16 +/- SELECT COUNT(*) FROM PUBLIC.USE;    
...
(23, 'Bento', 'Bento', 'Bento', 'Bento', 'user', 'BentoBento');           
...
CREATE MEMORY TABLE "PUBLIC"."HISTORICO_DE_JOGADAS"(
    "ID_JOGADA" INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1 RESTART WITH 30) NOT NULL,
...
-- 11 +/- SELECT COUNT(*) FROM PUBLIC.HISTORICO_DE_JOGADAS;   
...
(25, 18, 24, TIMESTAMP '2024-02-18 14:14:44'),
(26, 18, 1, TIMESTAMP '2024-02-18 16:57:34'),
(27, 23, 25, TIMESTAMP '2024-02-18 17:01:31'),
(29, 23, 2, TIMESTAMP '2024-02-18 17:02:56');   
...
-- 8 +/- SELECT COUNT(*) FROM PUBLIC.JOGOS_MAIS_JOGADOS;      
...
CREATE MEMORY TABLE "PUBLIC"."BENTO"(
    "ID" INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1 RESTART WITH 2) NOT NULL,
    "TEXTO" CHARACTER VARYING(255) NOT NULL,
    "OP1" CHARACTER VARYING NOT NULL,
    "REF1" INTEGER NOT NULL,
...
-- 1 +/- SELECT COUNT(*) FROM PUBLIC.BENTO;   
INSERT INTO "PUBLIC"."BENTO" VALUES
(1, '1', '1', 1, '1', 1, '1', 1, 'https://i.pinimg.com/originals/72/7c/0d/727c0ddf111b9db085d7dc7909ae3eae.gif');        
...
CREATE FORCE TRIGGER "PUBLIC"."ATUALIZARNOMETABLEJOGO" AFTER INSERT ON "PUBLIC"."JOGOS" FOR EACH ROW QUEUE 1024 CALL 'br.com.wmjc.db.trigger.AtualizarNomeTableJogoTrigger';  
