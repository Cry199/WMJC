-- H2 2.1.214;
;             
CREATE USER IF NOT EXISTS "SA" SALT '83d36b23e0ec02a1' HASH 'b35c8f975dcf595e2ae442d6e603bcd066b56519d30fc400c9f629c3b21711ae' ADMIN;         
...
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.HELLTAKER;               
...
(1, U&'Em meio \00c3\00a0 floresta densa, voc\00c3\00aa encontra uma bifurca\00c3\00a7\00c3\00a3o na trilha.', U&'Seguir pela trilha \00c3\00a0 esquerda', 2, U&'Seguir pela trilha \00c3\00a0 direita', 3, 'Parar e analisar o ambiente', 4, 'https://i.pinimg.com/originals/0a/87/36/0a8736b8d16a414b76b37713e5314879.gif');           
...
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.TESTE;   
