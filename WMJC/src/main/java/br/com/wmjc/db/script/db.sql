-- H2 2.1.214;
;             
CREATE USER IF NOT EXISTS "SA" SALT 'e53005788cebe259' HASH 'fa2985ceaffd1f3b5836262c43ba43a6cb44c953c6bfcea551b53462a4d24999' ADMIN;         
...
CREATE MEMORY TABLE "PUBLIC"."COMENTARIOSPERFIL"(
    "ID" INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1 RESTART WITH 79) NOT NULL,
    "IDDOUSER" INTEGER NOT NULL,
    "IDPERFIL" INTEGER NOT NULL,
    "COMENTARIO" CHARACTER VARYING
);      
ALTER TABLE "PUBLIC"."COMENTARIOSPERFIL" ADD CONSTRAINT "PUBLIC"."CONSTRAINT_E" PRIMARY KEY("ID");            
-- 13 +/- SELECT COUNT(*) FROM PUBLIC.COMENTARIOSPERFIL;      
...
-- 12 +/- SELECT COUNT(*) FROM PUBLIC.COMENTARIODEJOGO;       
