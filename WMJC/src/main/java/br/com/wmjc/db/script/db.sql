-- H2 2.1.214;
;             
CREATE USER IF NOT EXISTS "SA" SALT '5f388b1ea1f057a7' HASH '3c4f9c37788cadb45e3535881d6015478e02a0e3faa3bb2d203521776ab09621' ADMIN;         
...
CREATE MEMORY TABLE "PUBLIC"."HISTORICO_DE_JOGADAS"(
    "ID_JOGADA" INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1 RESTART WITH 22) NOT NULL,
...
(21, 18, 24, TIMESTAMP '2024-02-12 13:10:03');  
