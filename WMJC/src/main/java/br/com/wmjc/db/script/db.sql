-- H2 2.1.214;
;             
CREATE USER IF NOT EXISTS "SA" SALT 'f424e4edcacd2d0a' HASH '5cb694d931a16c4e2e817dca0e233ef09950f17bc8320dc5d5cd5cbc06f98b8f' ADMIN;         
...
-- 27 +/- SELECT COUNT(*) FROM PUBLIC.COMENTARIOSPERFIL;      
