-- H2 2.1.214;
;             
CREATE USER IF NOT EXISTS "SA" SALT 'e6b190a051ee392b' HASH 'c5767ff31412f90980a2c14ab668405601e554437fd8c605b8045db82586cca9' ADMIN;         
...
(1, 1, 'PerfilJoao', 'https://i.pinimg.com/564x/d3/23/72/d32372672b17a811080e127a1c99a2df.jpg', 'user'),
(2, 2, 'A', 'a', 'admin'),
