-- H2 2.1.214;
;             
CREATE USER IF NOT EXISTS "SA" SALT '059b77d9937c0ebd' HASH '62fa9a03b4c34cde0adbd147c8719d6d0933a1a4a7fcc0f5458845b04f04b56a' ADMIN;         
...
CREATE MEMORY TABLE "PUBLIC"."COMENTARIOSPERFIL"(
    "ID" INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1 RESTART WITH 91) NOT NULL,
    "IDDOUSER" INTEGER NOT NULL,
    "IDPERFIL" INTEGER NOT NULL,
    "COMENTARIO" CHARACTER VARYING
);      
ALTER TABLE "PUBLIC"."COMENTARIOSPERFIL" ADD CONSTRAINT "PUBLIC"."CONSTRAINT_E" PRIMARY KEY("ID");            
-- 16 +/- SELECT COUNT(*) FROM PUBLIC.COMENTARIOSPERFIL;      
...
CREATE MEMORY TABLE "PUBLIC"."COMENTARIODEJOGO"(
    "ID" INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1 RESTART WITH 30) NOT NULL,
    "IDDOUSER" INTEGER NOT NULL,
    "IDJOGO" INTEGER NOT NULL,
    "COMENTARIO" CHARACTER VARYING
);         
ALTER TABLE "PUBLIC"."COMENTARIODEJOGO" ADD CONSTRAINT "PUBLIC"."CONSTRAINT_1E" PRIMARY KEY("ID");            
-- 23 +/- SELECT COUNT(*) FROM PUBLIC.COMENTARIODEJOGO;       
