-- H2 2.1.214;
;             
CREATE USER IF NOT EXISTS "SA" SALT 'cb4ce046b8a64629' HASH 'd2c9fba3c31facc5f2144272352f76906030ec900504461eb6df364b12845150' ADMIN;         
...
CREATE MEMORY TABLE "PUBLIC"."COMENTARIOSPERFIL"(
    "ID" INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1 RESTART WITH 67) NOT NULL,
    "IDDOUSER" INTEGER NOT NULL,
    "IDPERFIL" INTEGER NOT NULL,
    "COMENTARIO" CHARACTER VARYING
);      
ALTER TABLE "PUBLIC"."COMENTARIOSPERFIL" ADD CONSTRAINT "PUBLIC"."CONSTRAINT_E" PRIMARY KEY("ID");            
-- 25 +/- SELECT COUNT(*) FROM PUBLIC.COMENTARIOSPERFIL;      
