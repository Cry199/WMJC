-- H2 2.1.214;
;             
CREATE USER IF NOT EXISTS "SA" SALT 'c855d243eefdef69' HASH '5e44568813096c7e9b18b87985abcbf9b21290ccc85f7be047d79d60fa87f90a' ADMIN;         
...
-- 13 +/- SELECT COUNT(*) FROM PUBLIC.COMENTARIODEJOGO;       
